...
public class Bucket {
    ...
    public static Bucket get(KBCClient client, HttpAPIRoute route) {
        ...
        if (bucketName == null) {
            ...
            throw new IllegalArgumentException("The bucket name of the provided route is unknown. Report to KookDesktop authors if you saw this!");
        }
    ...
    static {
        ...
        bucketNameMap.put(HttpAPIRoute.GUILD_FOLDERS, "guild/folders");
