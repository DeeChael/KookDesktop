...
import net.deechael.kookdesktop.KookDesktopMainKt;
...
public class ConsoleCommandSenderImpl implements ConsoleCommandSender {
    ...
    public static synchronized ConsoleCommandSender get(Plugin plugin) {
        return INSTANCES.computeIfAbsent(plugin, i -> new ConsoleCommandSenderImpl(KookDesktopMainKt.getCLI_LOGGER()));
    }
}
